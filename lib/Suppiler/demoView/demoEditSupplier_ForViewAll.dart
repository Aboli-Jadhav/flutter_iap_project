...
class Edit_For_ViewAll extends StatefulWidget {
  ...
  const Edit_For_ViewAll({Key? key, required this.supplierModel,required this.scopedatamodel}) : super(key: key);

  @override
  _Edit_For_ViewAllState createState() => _Edit_For_ViewAllState();
}

class _Edit_For_ViewAllState extends State<Edit_For_ViewAll>
{
        ...
        appBar: AppBar(
          leading: IconButton(
            onPressed: () {
              ...
              Navigator.push(context, MaterialPageRoute(builder: (context) => view_All_Supplier_Data()));
            },
