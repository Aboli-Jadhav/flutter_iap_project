...
class view_ALL_Scrap extends StatefulWidget {

  const view_ALL_Scrap({Key? key}) : super(key: key);

  @override
  _view_ALL_ScrapState createState() => _view_ALL_ScrapState();
}

class _view_ALL_ScrapState extends State<view_ALL_Scrap> {
