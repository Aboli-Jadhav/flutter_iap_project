...
class front_view_gauge_masteradmin extends StatefulWidget {
  List<String> gauge_name = [];
  List<String> gauge_location = [];



  front_view_gauge_masteradmin({required this.gauge_name,required this.gauge_location});

  @override
  _front_view_gaugeState createState() => _front_view_gaugeState();
}

class _front_view_gaugeState extends State<front_view_gauge_masteradmin> {
