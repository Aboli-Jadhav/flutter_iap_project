...
class view_master_gauge_masteradmin_All extends StatefulWidget {
  final List<String> gauge_location;

  const view_master_gauge_masteradmin_All(
      {Key? key,required this.gauge_location})
      : super(key: key);
...
class _view_master_gauState extends State<view_master_gauge_masteradmin_All> {
