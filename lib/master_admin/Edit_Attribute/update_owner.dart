...
class update_owner extends StatefulWidget {
  const update_owner({Key? key}) : super(key: key);

  @override
  _update_ownerState createState() => _update_ownerState();
}

class _update_ownerState extends State<update_owner> {
              ...
              child: Form(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelText: 'Enter Location Owner',
                  ),
                ),
              ),
            ),
